...
public class Component extends AbstractComponent {
	...
	public void addUI(Composite composite) {
		...
		properties.put(WireConstants.WIREADMIN_PRODUCER_FLAVORS, new Class[] { Sprint.class });
		properties.put(WireConstants.WIREADMIN_CONSUMER_FLAVORS, new Class[] { Sprint.class });
