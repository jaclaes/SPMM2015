...
public class Component extends AbstractComponent {
	...
	public void addUI(Composite composite) {
		...
		properties.put(WireConstants.WIREADMIN_CONSUMER_FLAVORS, new Class[] { ProductBacklogItem.class });
		properties.put(EventConstants.EVENT_TOPIC, new String[] {"at/floxx/scrumify/coreObjectProvider/*"});
