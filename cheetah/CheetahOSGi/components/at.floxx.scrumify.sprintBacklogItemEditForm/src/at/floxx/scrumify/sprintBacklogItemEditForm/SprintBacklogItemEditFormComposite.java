...
/**Contains the SprintBacklogItemEditForm GUI.
 * @author Mathias Breuss
 *
 */
public class SprintBacklogItemEditFormComposite extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		SprintBacklogItemEditFormComposite inst = new SprintBacklogItemEditFormComposite(shell, SWT.NULL);
	 ...
	 * @param style
	 */
	public SprintBacklogItemEditFormComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
