...
public class NumberOfReconciliationPhasesStatistic implements IPpmStatistic {
	@Override
	public String getHeader() {
		return "Number of Reconciliation Phases";
	}

	@Override
	public String getName() {
		return "The number of reconciliation phases in the PPM.";
	}
