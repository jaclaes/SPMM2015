...
/**
 * A vertex representation for the ShortestPathRouting. Vertices are either one of four corners on an <code>Obstacle</code>(Rectangle), or
 * one of the two end points of a <code>Path</code>.
 * 
...
class Vertex extends Point {
	...
	/**
	 * Creates a point that represents this vertex offset by the given amount times the offset.
	 * 
	 * @param modifier
	 *            the offset
	...
	/**
	 * Returns a Rectangle that represents the region around this vertex that paths will be traveling in.
	 * 
	 * @param extraOffset
