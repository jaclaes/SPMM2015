...
/**
 * A Segment representation for the ShortestPathRouting. A segment is a line between two vertices.
 * 
...
class Segment {
	...
	/**
	 * Returns a number that represents the sign of the slope of this segment. It does not return the actual slope.
	 * 
