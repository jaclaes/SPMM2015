...
public class MutualExclusionConstraintTest {
	private Game game;
	...
	@Test
	public void onlyOneFailure() {
		MutualExclusionConstraint constraint = new MutualExclusionConstraint(activityConfigA, activityConfigB);
