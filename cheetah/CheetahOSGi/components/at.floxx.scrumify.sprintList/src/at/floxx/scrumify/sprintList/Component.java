...
public class Component extends AbstractComponent {
	...
	public void addUI(Composite composite) {
		...
		properties.put(WireConstants.WIREADMIN_PRODUCER_FLAVORS, new Class[] { ReleasePlan.class });
		properties.put(WireConstants.WIREADMIN_CONSUMER_FLAVORS, new Class[] { ReleasePlan.class, Sprint.class });
		properties.put(EventConstants.EVENT_TOPIC, new String[] {"at/floxx/scrumify/sprintEditForm/*", "at/floxx/scrumify/coreObjectProvider/*"});
