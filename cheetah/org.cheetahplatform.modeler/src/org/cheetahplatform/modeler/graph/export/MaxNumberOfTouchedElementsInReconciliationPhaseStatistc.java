...
public class MaxNumberOfTouchedElementsInReconciliationPhaseStatistc extends AbstractMaxNumberOfTouchedElementsStatistic {
	...
	public String getHeader() {
		return "Max. # Diff. Touched Elements/Rec.";
	}

	@Override
	public String getName() {
		return "Max. Number of different touched elements (edges and nodes) per reconcliliation phase. Ignoring renaming";
	}
}
