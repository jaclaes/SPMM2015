...
public class Component extends AbstractComponent {
	...
	public void addUI(Composite composite) {
		...
		properties.put(WireConstants.WIREADMIN_PRODUCER_FLAVORS, new Class[] { ProductBacklogItem.class });
		properties.put(WireConstants.WIREADMIN_CONSUMER_FLAVORS, new Class[] { Product.class, ProductBacklogItem.class, Sprint.class });
		properties.put(EventConstants.EVENT_TOPIC, 
				new String[]{"at/floxx/scrumify/productBacklogItemEditForm/*",
							"at/floxx/scrumify/coreObjectProvider/*" });
