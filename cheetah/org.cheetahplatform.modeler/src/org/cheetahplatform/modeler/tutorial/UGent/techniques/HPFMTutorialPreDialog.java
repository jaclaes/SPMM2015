...
public class HPFMTutorialPreDialog extends TitleAreaDialog {
	...
	public HPFMTutorialPreDialog(Shell parentShell) {
		super(parentShell);
		index = 0;
		screencasts = new String[4];
		for (int i = 1; i <= 4; i++) {
			screencasts[i - 1] = "screencasts/UGentVideo/Slides/HPFMSlide" + i + "/HPFMSlide" + i + ".htm";
		}
	}
