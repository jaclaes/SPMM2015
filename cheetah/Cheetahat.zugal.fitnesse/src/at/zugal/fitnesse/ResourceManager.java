 ...
 * 
 * !!! IMPORTANT !!! Application code must explicitly invoke the <code>dispose()</code> method to release the operating system resources
...
public class ResourceManager extends SWTResourceManager {
	...
	/**
	 * Dispose of cached objects and their underlying OS resources. This should only be called when the cached objects are no longer needed
	 ...
	 */
	public static ImageDescriptor getImageDescriptor(Class<Object> clazz, String path) {
