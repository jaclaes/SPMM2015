...
public class Component extends AbstractComponent {
	...
	public void addUI(Composite composite) {
		...
		properties.put(WireConstants.WIREADMIN_CONSUMER_FLAVORS, new Class[] { Object.class });
		...
		consumerServiceRegistration = Activator.getBundleContext()
	...
	public void unregister() {
		if (consumerServiceRegistration != null)
