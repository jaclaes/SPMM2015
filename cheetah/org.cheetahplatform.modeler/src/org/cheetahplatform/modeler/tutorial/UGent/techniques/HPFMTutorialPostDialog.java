...
public class HPFMTutorialPostDialog extends TitleAreaDialog {

	private static final int CLOSE_BUTTON_ID = 20000;
	private Browser screencastBrowser;

	public HPFMTutorialPostDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		showScreencast("screencasts/UGentVideo/HPFMBigModel/HPFMBigModel.htm");
