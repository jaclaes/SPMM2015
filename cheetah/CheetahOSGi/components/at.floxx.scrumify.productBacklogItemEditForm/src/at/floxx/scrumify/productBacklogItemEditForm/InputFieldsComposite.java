...
public class InputFieldsComposite extends org.eclipse.swt.widgets.Composite {
	...
	*/
	...
	/**
	 * @return the estimationText
	 */
	public Text getEstimationText() {
	...
	*/
	...
	private void initGUI() {
		try {
			...
			descriptionTextLData.verticalAlignment = GridData.BEGINNING;
			descriptionText.setLayoutData(descriptionTextLData);
			descriptionText.setSize(300, 200);
			{
				estimationLabel = new Label(this, SWT.NONE);
				estimationLabel.setText("Estimation:");
				GridData estimationLabelLData = new GridData();
				estimationLabel.setLayoutData(estimationLabelLData);
			}
			{
				estimationText = new Text(this, SWT.NONE);
				estimationText.setText("0");
				GridData estimationTextLData = new GridData();
				estimationTextLData.horizontalAlignment = GridData.FILL;
				estimationText.setLayoutData(estimationTextLData);
			}
