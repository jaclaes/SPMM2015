...
public class SPMTutorialDialog extends TitleAreaDialog {
	...
	private int index;
	private String[] messages = { Messages.SPMTutorialStep1_0, Messages.SPMTutorialStep2_0, Messages.SPMTutorialStep3_0,
			Messages.SPMTutorialStep4_0, Messages.SPMTutorialStep5_0, Messages.SPMTutorialStep6_0 };
	private String[] screencasts;
	protected TutorialComposite composite;

	public SPMTutorialDialog(Shell parentShell) {
		super(parentShell);
		index = 0;
		int numSteps = 6;
		screencasts = new String[numSteps];
		for (int i = 1; i <= numSteps; i++) {
			screencasts[i - 1] = "screencasts/UGentVideo/Steps/SPM-Step" + i + "/SPM-Step" + i + ".htm";
		}
	}
