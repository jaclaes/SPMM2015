...
public class ComponentUiController implements IComponentUiController {
	...
	private void initGUI() {
		...
		updateButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (item != null) {
					item.setProjectName(nameText.getText());
					item.setReleaseGoalDescription(descriptionText.getText());

					GregorianCalendar start = new GregorianCalendar();
					start.set(startDateTime.getYear(),
							startDateTime.getMonth(), startDateTime.getDay());
		...
		newButton.addSelectionListener(new SelectionListener() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				item = Activator.getObjectProviderService().createReleasePlan(
				...
				item.setSprints(new ArrayList<Sprint>());
	...
	private void updateForm(ReleasePlan item) {
		this.item = item;
		this.nameText.setText(item.getProjectName());
		this.descriptionText.setText(item.getReleaseGoalDescription());
	...
	public void updated(Wire wire, Object value) {
		ReleasePlan item = (ReleasePlan) value;
		updateForm(item);
	}
	...
	private void reloadItemList() {
		...
		Event relaodItemListEvent = new Event(
				"at/floxx/scrumify/releasePlanEditForm/Event", prop);
